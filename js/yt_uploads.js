...
function getVids() {
  $.get(
    "https://www.googleapis.com/youtube/v3/playlistItems",
    {
      ...
      key: apiKey // set this variable to your API key in "key.js"
    },
    ...
    function(data) {
      ...
      if (data.items.length > 0) {
        ...
        // No videos found
        $("#haxvidsstatus").html(
          "No Videos. Feed me!<br><img src='https://media.giphy.com/media/uAEXaY2T99zeE/giphy.gif'>"
        );
      }
    }
  ).error(function() {
    $("#haxvidsstatus").html(
      "OOF! Failed to load videos. Try again in a couple hours.<br><img src='https://media.giphy.com/media/rZxMZGtDcKdS8/giphy.gif'>"
    );
  });
}
